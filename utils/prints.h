...
void print_functional_unit(functional_unit_status_table_t *table)
{
  ...
  printf("%i Mult1 \t| %s \t| %i \t| %i \t| %i \t| %i \t| %i \t| %i \t| %i \t| %i\n",
         table->mult1.time,
         ...
         table->mult1.fj_Rj,
         table->mult1.fj_Rk);
  printf("%i Mult2 \t| %s \t| %i \t| %i \t| %i \t| %i \t| %i \t| %i \t| %i \t| %i\n",
         table->mult2.time,
         ...
         table->mult2.fj_Rj,
         table->mult2.fj_Rk);
  printf("%i Add \t\t| %s \t| %i \t| %i \t| %i \t| %i \t| %i \t| %i \t| %i \t| %i\n",
         table->add.time,
         ...
         table->add.fj_Rj,
         table->add.fj_Rk);
  printf("%i Div \t\t| %s \t| %i \t| %i \t| %i \t| %i \t| %i \t| %i \t| %i \t| %i\n",
         table->divide.time,
         table->divide.busy ? "Yes" : "No",
         table->divide.op,
         table->divide.dest_Fi,
         table->divide.s1_Fj,
         table->divide.s2_Fk,
         table->divide.fu_Qj,
         table->divide.fu_Qk,
         table->divide.fj_Rj,
         table->divide.fj_Rk);
  printf("%i Log \t\t| %s \t| %i \t| %i \t| %i \t| %i \t| %i \t| %i \t| %i \t| %i\n",
         table->log.time,
